...
export const points = [
  ...
  },
  {
    id: "vision",
    heading: "OUR VISION",
    body: "Para peserta dapat menginspirasi dan memotivasi satu sama lain untuk mencapai prestasi terbaik. Tidak hanya sekadar perlombaan fisik, tetapi juga ujian mental untuk mengatasi rintangan dan mencapai garis finish. Lomba lari adalah ajang di mana semangat juang dan kerja keras bertemu, dan di mana kemenangan bukan hanya tentang mencapai garis akhir, tetapi juga tentang perjalanan menuju pencapaian itu.",
  },
];
