...
export default function AboutMissionVision() {
  ...
  hidden sm:block"
                  >
                        <Badge label="5K" className="absolute left-4 top-6" />
                        <Badge label="10K" className="absolute right-6 top-16" />
                        <Badge label="21 K" className="absolute left-10 top-24" />
                        <Badge label="RUNNERS" className="absolute right-10 top-32" />
                        <Badge label="PACER" className="absolute left-6 bottom-16" />
                  </div>
                </div>
              </>
            ) : (
